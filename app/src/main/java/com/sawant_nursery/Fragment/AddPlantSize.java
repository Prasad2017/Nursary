 ...
 */
public class AddPlantSize extends Fragment {
   ...
   FormEditText productSize;
    ...
    private void addProductSize(String prodSize) {
        ...
        progressDialog.setTitle("Size is in creating");
        progressDialog.setProgressStyle(ProgressDialog.STYLE_SPINNER);
        progressDialog.show();
        progressDialog.setCancelable(false);

        ApiInterface apiInterface = Api.getClient().create(ApiInterface.class);
        Call<LoginResponse> call = apiInterface.addProductSize(MainPage.userId, prodSize);
